...
**Part A: Pair in Android Settings** ⚙️
...
### 2. Connect via App 🔗
* **Important:** ⚠️ DO NOT try to pair via the iPhone's main "Settings" menu. BLE connections must be made *inside* the app.
...
2.  The connection remains stable for at least 30 seconds (no drops). ⏱️
3.  Data can be sent **from Phone to ESP32** successfully. 📲 ➡️ 📟
4.  Data can be sent **from ESP32 to Phone** successfully. 📟 ➡️ 📲
